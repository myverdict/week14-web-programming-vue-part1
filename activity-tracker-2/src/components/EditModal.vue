  ...
  <div>
    ...
    >
      ...
      <div class="form-group">
        <label class="form-label" for="edit-date-input"
          >What date did you practice art?</label
        >
      ...
      <div class="form-check-inline">
        <input
          id="edit-media1-input"
          class="form-check-input"
          type="radio"
          v-bind:value="media.traditional"
          v-model="updateMedium"
        />
      ...
      <div class="form-check pb-3 pt-3">
        ...
        <label class="form-check-label" for="edit-status-input"
          >Completed?</label
        >
      </div>
